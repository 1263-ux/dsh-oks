		...
		*/
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									...
									style: {
										...
										height: 30,
										padding: 0,
										border: `1px solid ${Boolean(v.prestep_enabled ?? true) ? T$2.success : "#c4c9d1"}`,
										borderRadius: 999,
										background: Boolean(v.prestep_enabled ?? true) ? T$2.success : "#d9dde3",
										color: T$2.labelSecondary,
										cursor: "pointer",
										fontSize: 10,
										fontWeight: 700,
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: { color: Boolean(v.prestep_enabled ?? true) ? "rgba(255,255,255,.78)" : "#4b5563" },
											children: "OFF"
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: { color: Boolean(v.prestep_enabled ?? true) ? T$2.success : "#6b7280" },
											children: "ON"
										})]
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										"aria-hidden": "true",
		...
		function KnowledgeRecallSwitch({ scope }) {
			...
			const toggleStyle = {
				...
				flex: "0 0 auto",
				padding: 0,
				border: `1px solid ${enabled ? T.success : "#c4c9d1"}`,
				borderRadius: 999,
				background: enabled ? T.success : "#d9dde3",
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: { color: enabled ? "rgba(255,255,255,.78)" : "#4b5563" },
									children: "OFF"
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: { color: enabled ? T.success : "#6b7280" },
									children: "ON"
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
