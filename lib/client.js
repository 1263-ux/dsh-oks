			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								hasWarnings && !hasErrors ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: {
										color: T.labelSecondary,
										fontSize: 10,
										marginTop: 2
									},
									children: "内容关系提醒，不影响知识库连接与召回。"
								}) : null
							] })]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
					...
					result && result.items.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: expanded ? "收起详情" : `展开 ${result.items.length} 条详情`
					}) : null
				]
			});
		}
