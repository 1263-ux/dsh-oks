	...
	factory: (require) => {
		...
		*/
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: expanded ? "改 → 自动同步到 OKS 配置" : `当前：recall ${Number(v.recall_floor ?? .7)} · 每次 ${Number(v.recall_topn ?? 3)} 条`
						})]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						"aria-hidden": "true",
						style: {
					...
					children: !snap.writable ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								id: gid("pe"),
								lab: "自动召回",
								h: "开启后，每轮回答前由 OKS 依据知识库的召回参数执行；关闭后仍可手动调用 oks_recall。",
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									id: gid("pe"),
									type: "button",
									role: "switch",
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: { color: Boolean(v.prestep_enabled ?? true) ? T$2.labelSecondary : T$2.labelPrimary },
											children: "OFF"
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: { color: Boolean(v.prestep_enabled ?? true) ? T$2.labelPrimary : T$2.labelSecondary },
											children: "ON"
										})]
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										"aria-hidden": "true",
										style: {
											position: "absolute",
											top: 3,
											left: Boolean(v.prestep_enabled ?? true) ? 42 : 3,
											width: 32,
											height: 22,
											borderRadius: 999,
											background: Boolean(v.prestep_enabled ?? true) ? T$2.brand : T$2.bgLayer2,
		...
		function WikiBrowser({ rpc, onOpenSettings }) {
			...
			const [pageDataByTab, setPageDataByTab] = (0, react.useState)({});
			...
			(0, react.useEffect)(() => {
				const controller = new AbortController();
				callOksRpc(rpc, "/oks", "diagnostics", {}, controller.signal).then((diagnosticsResult) => {
					if (controller.signal.aborted) return;
			...
			const pageData = tab === "raw" ? void 0 : pageDataByTab[tab];
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					items.map((item) => {
						const id = tab === "raw" ? item.id : item.slug;
						const opening = openingId === id;
						return tab === "raw" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							disabled: opening,
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [item.captureId, opening ? " · 打开中…" : ""]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: {
										marginTop: 3,
						...
						}, id) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							disabled: opening,
							onClick: () => void open(id),
							style: {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [item.title, opening ? " · 打开中…" : ""]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: {
										marginTop: 3,
		...
		function KnowledgeRecallSwitch({ scope }) {
			...
			const toggleStyle = {
				...
				flex: "0 0 auto",
				padding: 0,
				border: `1px solid ${enabled ? T.brandBorder : T.border}`,
				borderRadius: 999,
				background: enabled ? T.brandBorder : T.border,
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: { color: enabled ? T.labelSecondary : T.labelPrimary },
									children: "OFF"
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: { color: enabled ? T.labelPrimary : T.labelSecondary },
									children: "ON"
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								style: {
									...
									height: 22,
									borderRadius: 999,
									background: enabled ? T.brand : T.bgLayer2,
									boxShadow: "0 1px 3px rgba(15, 23, 42, .22)",
									transition: "left .16s ease"
								}
							}),
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: displayCount(count, summaryLoading)
						})]
					}, String(label)))
				}),
