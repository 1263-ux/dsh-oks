		...
		*/
					...
					children: !snap.writable ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
									id: gid("re"),
									lab: "启用 OKS 召回",
									h: "关闭后，自动召回、oks_recall 工具和工具后的记忆提示都会停止；知识库浏览不受影响。",
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										id: gid("re"),
										type: "button",
										role: "switch",
										"aria-checked": Boolean(v.recall_enabled ?? true),
										...
										style: {
											...
											borderRadius: 999,
											padding: "7px 11px",
											background: Boolean(v.recall_enabled ?? true) ? T$2.brand : T$2.border,
											color: "#fff",
											cursor: "pointer",
											fontSize: 12,
											fontWeight: 600
										},
										children: Boolean(v.recall_enabled ?? true) ? "已开启" : "已关闭"
									})
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
									id: gid("rf"),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
									id: gid("pe"),
									lab: "自动召回",
									h: "开启后，每轮回答前自动召回相关 Wiki；关闭后仍可手动调用 oks_recall（总开关开启时）。",
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										id: gid("pe"),
										type: "button",
										role: "switch",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
									id: gid("ps"),
									lab: "旧版信号门槛（兼容保留）",
									h: "新版由 OKS CLI 的工具召回门槛统一控制；此字段仅保留旧配置，不再作为第二次过滤",
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
										id: gid("ps"),
										style: input$1,
										type: "number",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								id: gid("vfs"),
								lab: "VFS 虚拟文件系统",
								h: "Wiki / Raw 页面的文件枚举默认走原生 fs；开启后改用 oks fs 命令（内置路径穿越与软链逃逸防护），需已安装 OKS 0.6.5+，否则自动回退原生 fs。",
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									id: gid("vfs"),
									type: "button",
									role: "switch",
									"aria-checked": Boolean(v.vfs_enabled ?? false),
									...
									style: {
										...
										borderRadius: 999,
										padding: "7px 11px",
										background: Boolean(v.vfs_enabled ?? false) ? T$2.brand : T$2.border,
										color: "#fff",
										cursor: "pointer",
										fontSize: 12,
										fontWeight: 600
									},
									children: Boolean(v.vfs_enabled ?? false) ? "已开启" : "已关闭"
								})
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function KnowledgeRecallSwitch({ scope }) {
			...
			const update = async (next) => {
				...
				setError("");
				try {
					await scope.set("recall_enabled", next);
				} catch {
					setError("OKS 召回开关保存失败，请稍后重试。");
				} finally {
					setSaving(false);
				}
			};
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: "开启后允许自动召回、Agent 调用 oks_recall 和工具后的记忆提示。关闭后仍可浏览知识库、查看状态和健康检查。"
						})]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						role: "switch",
		...
		function HealthCheckCard({ rpc }) {
			...
			const runLint = () => {
				setLoading(true);
				setExpanded(false);
				callOksRpc(rpc, "/oks", "lint", {}, void 0).then((r) => {
					if (r.ok) {
						setResult(r.value);
						setExpanded(!r.value?.passed);
					}
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: loading ? "检查中" : result ? "重新检查" : "运行检查"
						})]
					}),
					result?.summary ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							padding: "0 12px 8px",
							color: T.labelSecondary,
							fontSize: 11,
					...
					result && result.items.length > 0 && expanded ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							borderTop: `1px solid ${T.border}`,
							padding: "8px 12px"
						},
						children: result.items.map((item, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								padding: "4px 0",
								color: i < result.errors ? T.danger : T.warning,
								fontSize: 11,
								lineHeight: 1.45
							},
							children: [i < result.errors ? "✗ " : "! ", item]
						}, i))
					}) : null,
					result && result.items.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						...
						children: expanded ? "收起详情" : `展开 ${result.items.length} 个问题`
					}) : null
				]
			});
		}
		...
		function TierDistributionCard({ rpc }) {
			const [tiers, setTiers] = (0, react.useState)(null);
			const [loading, setLoading] = (0, react.useState)(false);
			(0, react.useEffect)(() => {
				const controller = new AbortController();
				setLoading(true);
				callOksRpc(rpc, "/oks", "status-tiers", {}, controller.signal).then((r) => {
					if (!controller.signal.aborted && r.ok) setTiers(r.value);
				}).catch(() => void 0).finally(() => {
					if (!controller.signal.aborted) setLoading(false);
				});
				return () => controller.abort();
			}, [rpc]);
			if (loading && !tiers) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				style: {
					padding: "12px",
					border: `1px solid ${T.border}`,
					borderRadius: 10,
			...
			const entries = Object.entries(tierMeta).map(([key, meta]) => ({
				key,
				...meta,
				count: tiers[key]
			}));
				...
				children: [
					...
					total > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: entries.map((e) => e.count > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { style: {
					...
					Object.keys(tiers.types).length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							padding: "0 12px 10px",
							display: "flex",
							gap: 8,
						...
						children: [Object.entries(tiers.types).map(([type, count]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							style: {
								fontSize: 10,
								color: T.labelSecondary,
								padding: "2px 6px",
						...
						}, type)), tiers.pinned > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							style: {
								fontSize: 10,
								color: T.warning,
								padding: "2px 6px",
		...
		function WorkspaceOverview({ scope, rpc, onOpen, openSidebar }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(HealthCheckCard, { rpc }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TierDistributionCard, { rpc }),
		...
		function getOksRpc(ctx) {
			...
			return candidate && typeof candidate.call === "function" ? candidate : unavailableRpc();
		}
		function installSidebar(ctx, scope, rpc) {
			ctx.plugin({
